...
export default function CorrelationHeatmap() {
  ...
  return (
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.25rem 0 0 0', fontSize: '0.78rem', color: '#64748B' }}>
              Derived from {eda.total_observations ? eda.total_observations.toLocaleString() : '--'} hourly observations ({eda.data_source || 'Hopsworks Feature Store V2'})
            </p>
          </div>
        </div>
      ...
      {/* 24-Hour Diurnal Pollution Profile Spline */}
      {eda.hourly_diurnal_profile && (
        <div style={{
          backgroundColor: '#FFFFFF',
          borderRadius: '1.25rem',
          padding: '1.6rem',
          ...
          <div style={{ height: '260px', width: '100%' }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={
                Array.isArray(eda.hourly_diurnal_profile)
                  ? eda.hourly_diurnal_profile
                  : Object.entries(eda.hourly_diurnal_profile.pm2_5 || {}).map(([hr, val]) => ({
                      hour: `${hr}:00`,
                      pm25: val,
                      aqi: eda.hourly_diurnal_profile.european_aqi ? eda.hourly_diurnal_profile.european_aqi[hr] : val
                    }))
              }>
                <defs>
